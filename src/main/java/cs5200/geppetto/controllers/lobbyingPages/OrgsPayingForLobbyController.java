...
@Controller
public class OrgsPayingForLobbyController {

		static Logger log = Logger.getLogger(OrgsPayingForLobbyController.class.getName());

		@Autowired
		private LobbyIndustryDao lobbyIndustryDao;

		@GetMapping("Lobby/orgsPayingForLobbying")
		public String welcome(Map<String, Object> model) throws SQLException {
				List<OrganizationsPaying> averageIndustryList = lobbyIndustryDao.getOrgsPayingTheMost();
				model.put("averageIndustryList", averageIndustryList);
				return "lobbyingPages/orgsPayingForLobbying";
		}
}

...
public interface PacToCandidateDao {
  ...
  List<PacToCandidateDonation> getDonationsByCandidate(Candidate candidate) throws SQLException;

  PacToCandidateDonation updateDonationDate(PacToCandidateDonation donation, Date date)
      throws SQLException;

  PacToCandidateDonation deleteDonation(PacToCandidateDonation donation) throws SQLException;
}
